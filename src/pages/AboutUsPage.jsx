...
const AboutUsPage = () => {
    return <>
        <div className="container mt-5">
            ...
            <img src={Foto1 == null ? Foto : Foto1} alt="" className="w-100 my-3 object-fit-cover shadow rounded" style={{maxHeight: "70vh", minHeight: "50vh"}} />
            ...
            <div className="row my-3 mb-5">
                <div className="col-md-3">
                    <img src={Foto2 == null ? Foto : Foto2} alt="" className='w-100 object-fit-cover shadow mb-3 rounded'/>
                </div>
            ...
            <div className="row my-3 mb-5">
                ...
                <div className="col-md-3 order-1 order-md-2">
                    <img src={Foto3 == null ? Foto : Foto3} alt="" className='w-100 object-fit-cover shadow mb-3 rounded'/>
                </div>
            </div>
